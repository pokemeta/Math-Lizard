	...
	<div class="edit_cont"></div>
		<form method="POST"  action="carga.php" enctype="multipart/form-data">
			<div class="opciones" id="content"  name="formula">
				...
				<center><input type="button" id="btn5" onclick="addoperacion()" name="titulobtn" value="insertar operacion" class="btn-tema"></center><br>
				<script type="text/javascript">
					...
					function addfield(){
						...
						input.id = "prueba";
						input.name = "cont[]";
						input.value = '<p class="texto-siz"></p>';
